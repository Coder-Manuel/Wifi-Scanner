...
//     * @see #isWifiApEnabled()
     */
    public WIFI_APP_STATE getWifiApState() {
        try {
            ...
            return WIFI_APP_STATE.class.getEnumConstants()[tmp];
        } catch (Exception e) {
            Log.e(this.getClass().toString(), "", e);
            return WIFI_APP_STATE.WIFI_AP_STATE_FAILED;
        }
    }
    ...
    public boolean isWifiApEnabled() {
        return getWifiApState() == WIFI_APP_STATE.WIFI_AP_STATE_ENABLED;
    }
...
public  void diable_network(int id){
